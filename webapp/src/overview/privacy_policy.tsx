...
export const Privacy_policy = () => {
    ...
    return (
        ...
        <>
            ...
            />
            <div data-custom-class="body" className="m-10">
                <div>
                    <strong>
                        ...
                        <strong>
                            <span style={{ fontSize: 15 }}>
                                <span data-custom-class="subtitle">
                                    Last updated
                                    <div className="question">April 22, 2024</div>
                                </span>
                            </span>
                        </strong>
                    </span>
                    ...
                    <span style={{ color: "rgb(127, 127, 127)" }}>
                        <span style={{ color: "rgb(89, 89, 89)", fontSize: 15 }}>
                            ...
                            <span data-custom-class="body_text">
                                ...
                                (
                                <div className="block-component" />"<strong>process</strong>"
                                <div className="statement-end-if-in-editor" />
                            ...
                            <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
                                <span data-custom-class="body_text">
                                    ...
                                    <span style={{ color: "rgb(0, 58, 250)" }}>
                                        <div className="question">AI-Attend</div>
                                    </span>
                                    <span style={{ fontSize: 15 }}>
                                        <span style={{ color: "rgb(89, 89, 89)" }}>
                                            <span data-custom-class="body_text">
                ...
                <div>
                        ...
                        <span style={{ fontSize: 15 }}>
                            <span style={{ color: "rgb(127, 127, 127)" }}>
                                <span data-custom-class="body_text">
                                    ...
                                    <div className="question">soniharshit186@gmail.com</div>.
                                </span>
                            </span>
                        </span>
                    </div>
                    ...
                    <div style={{ lineHeight: "1.5" }}>
                        ...
                        <a
                            ...
                            href="https://app.termly.io/notify/8abe504d-0d30-4a3e-b002-1c2df49d8f94"
                    ...
                    <div style={{ lineHeight: "1.5" }}>
                        ...
                        <a data-custom-class="link" href="#DNT"></a>
                    </div>
                    <a data-custom-class="link" href="#DNT">
                        <div style={{ lineHeight: "1.5" }}>
                            <div className="block-component">
                            ...
                            <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
                                <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
                                    <span data-custom-class="body_text">
                                        <span style={{ fontSize: 15 }}>
                                            <span data-custom-class="body_text">
                                                <div className="question">mailing addresses</div>
                                            </span>
                                        </span>
                                    </span>
                                </span>
